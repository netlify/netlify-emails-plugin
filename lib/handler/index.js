...
const handler = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        (0, preDelivery_1.default)(event, context);
    }
    catch (e) {
        return {
            statusCode: 400,
    ...
    const bytes = crypto_js_1.default.AES.decrypt(event.body, (_b = process.env.NETLIFY_EMAILS_TOKEN) !== null && _b !== void 0 ? _b : process.env.NEXT_PUBLIC_NETLIFY_EMAILS_TOKEN);
    ...
    client.sendEmail({
        ...
        To: requestBody._to,
        Subject: (_c = requestBody._subject) !== null && _c !== void 0 ? _c : "",
